...
def main(train_file, val_file, test_file):
    ...
    model = MultipleChoiceModel('microsoft/BiomedNLP-BiomedBERT-base-uncased-abstract-fulltext', num_choices=5, num_experts=Config.num_experts, tokenizer=tokenizer).to(Config.device)
